...
/// First non-reserved register in the [`VM`](https://github.com/Barca545/galaxy). Registers R4-R14 are reserved for function arguments.
pub const FIRST_FREE_REGISTER:usize = 15;
